...
export default function WhatsNewModal() {
    ...
    return (
        <div
            ...
            <div
                className={`bg-white/90 backdrop-blur-2xl rounded-3xl shadow-[0_24px_64px_0_rgba(0,0,0,0.25)] max-w-lg w-full  overflow-hidden transition-all duration-250 ${
                    exiting ? "scale-95 opacity-0" : "scale-100 opacity-100"
                }`}>
                {/* Header */}
                <div className="bg-secondary p-6 pb-5 relative">
                    <div className="flex items-center gap-3">
                        <div className="w-10 h-10 bg-white/20 rounded-xl flex items-center justify-center text-2xl">
                            🎉
                        </div>
                        <div>
                            <p className="text-white/80 text-xs font-bold uppercase tracking-widest mb-0.5">
                                {update.version}
                            </p>
                ...
                <div className="p-6 max-h-72 overflow-y-auto">
                    {update.changelog ? (
                        ...
                        <p className="text-neutral text-sm font-sans">
                ...
                <div className="px-6 pb-6 flex justify-end">
                    <button
                        onClick={handleDismiss}
                        className="bg-secondary hover:brightness-110 text-white font-bold py-3 px-8 rounded-xl shadow-lg transition-all hover:-translate-y-0.5 active:translate-y-0 text-sm">
                        Got it, let's go! ✨
                    </button>
                </div>
            </div>
